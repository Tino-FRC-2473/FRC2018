...
public class Devices {
	...
	private AnalogGyro[] analog_gyros; // collection storing the singular gryo, size could be subject to change in the
										// future if needed
	//private AHRS navX; // collection storing the singular navx gyro, size subject to change in the
						// future
	...
	private Devices() { // private constructor prevents the creation of such an object elsewhere,
						// forcing the use of the public static getInstance()
	 ...
	 * 
	 * @param port
	 *            an <code>int</code> value representing the device id of the talon
	 *            to be removed.
	 */
	...
	public WPI_TalonSRX getTalon(int id) {
		/*
		 * loop through the collection of existing talons: if a talon exists in the
		 * collection, return it, effectively breaking out of the loop and the function
		 * if the talon doesn't exist, the loop will go to completion, with nothing
		 * returned after which the talon can be added through addTalon and then
		 * returned in the next line as the last element in the collection
		 */
	 ...
	 * 
	 * @param port
	 *            an <code>int</code> value representing the port number of the
	 *            servo to be removed.
	 */
	 ...
	 * 
	 * @param port
	 *            an <code>int</code> value representing the channel port of the
	 *            servo
	 * @return a <code>Servo</code> object with the given channel port
	 */
	public Servo getServo(int port) {
		/*
		 * loop through the collection of existing servos: if a servo exists in the
		 * collection, return it, effectively breaking out of the loop and the function
		 * if the servo doesn't exist, the loop will go to completion, with nothing
		 * returned after which the servo can be added through addServo and then
		 * returned in the next line as the last element in the collection
		 */
	...
	/**
	 * Removes a given analog input sensor from the collection of such sensors in
	 * this class.
	 * 
	 * @param channel
	 *            an <code>int</code> value representing the channel port of the
	 *            analog input sensor to be removed.
	 */
	public void removeAnalogInput(int channel) {
		for (AnalogInput input : analogs) // loop through the analog inputs stored in this class
			if (input.getChannel() == channel) { // if the channel port matches, remove the sensor and break out of the
													// loop
	...
	public AnalogInput getAnalogInput(int channel) {
		/*
		 * loop through the collection of existing analog input sensors: if the sensor
		 * exists in the collection, return it, effectively breaking out of the loop and
		 * the function if the sensor doesn't exist, the loop will go to completion,
		 * with nothing returned after which the sensor can be added through
		 * addAnalogInput and then returned in the next line as the last element in the
		 * collection
		 */
	...
	/**
	 * Adds a analog input sensor to the collection of such sensors with the given
	 * channel port
	 * 
	 * @param channel
	 *            an <code>int</code> value representing the channel port of the
	...
	/**
	 * Removes a given digital input sensor from the collection of such sensors in
	 * this class.
	 * 
	 * @param channel
	 *            an <code>int</code> value representing the channel port of the
	 *            digital input sensor to be removed.
	 */
	...
	public DigitalInput getDigitalInput(int channel) {
		/*
		 * loop through the collection of existing digital input sensors: if the sensor
		 * exists in the collection, return it, effectively breaking out of the loop and
		 * the function if the sensor doesn't exist, the loop will go to completion,
		 * with nothing returned after which the sensor can be added through
		 * addDigitalInput and then returned in the next line as the last element in the
		 * collection
		 */
	 ...
	 * 
	 * @param port
	 *            a <code>int</code> value representing the channel port of the gyro
	 * @return an <code>AnalogGyro</code> object with the given channel port
	 */
	public AnalogGyro getGyro(int port) {
		/*
		 * check the collection of existing gyros: if the gyro exists in the collection,
		 * return it, effectively breaking out of the loop and the function if the gyro
		 * doesn't exist: add it to the collection then return it in the next line as
		 * the last element in the collection
		 */
		if (analog_gyros[0] != null)
	...
	/**
	 * Sets the robot's gyro to the collection of such sensors with the given
	 * channel port
	 * 
	 * @param port
	 *            an <code>int</code> value representing the channel port of the
	...
	/*public AHRS getNavXGyro() {
		/*
		 * set the NavX gyro for safety then return it
		setNavXGyro();
		return navX;
	}
